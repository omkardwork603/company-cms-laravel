        ...
        <div>
            <div class="flex justify-between items-center mb-1.5">
                ...
                <?php if(Route::has('password.request')): ?>
                    <a class="text-xs font-semibold text-indigo-600 hover:text-indigo-700 transition-colors" href="<?php echo e(route('password.request')); ?>">
                        Forgot Password?
                    </a>
                <?php endif; ?>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\company-cms-laravel-ne\company-cms\resources\views/auth/login.blade.php ENDPATH**/ ?>