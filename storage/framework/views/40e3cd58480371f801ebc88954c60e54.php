...
<?php $__env->startSection('title', 'Add Menu Item'); ?>

<?php $__env->startSection('page-title', 'Add Menu Item'); ?>
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-xl shadow p-8">
        ...
        <form
            action="<?php echo e(route('admin.menus.items.store', $menu)); ?>"
            method="POST"
        >
                ...
                >
                    ...
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <option
                            ...
                            <?php echo e(old('parent_id') == $item->id ? 'selected' : ''); ?>
