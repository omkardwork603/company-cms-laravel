        ...
        <div class="bg-white rounded-lg shadow p-8 mb-6 border-2 border-blue-500/20">
            ...
            <div class="mb-6">
                ...
                <input
                    type="text"
                    name="site_name"
                    value="<?php echo e(old('site_name', $setting->site_name ?? 'Our Company')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input
                    type="text"
                    name="site_tagline"
                    value="<?php echo e(old('site_tagline', $setting->site_tagline ?? 'Building Better Solutions for Your Business')); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    class="w-full border rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ><?php echo e(old('details', $setting?->details ?? 'We provide innovative solutions designed to help businesses grow, improve performance and achieve long-term success.')); ?></textarea>
        ...
        <div class="bg-white rounded-lg shadow p-8 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-2">
                ...
                <div>
                    ...
                    <?php if($setting->logo): ?>
                        <img
                            src="<?php echo e(asset('storage/' . $setting->logo)); ?>"
                            alt="Current logo"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <?php if($setting->favicon): ?>
                        <img
                            src="<?php echo e(asset('storage/' . $setting->favicon)); ?>"
                            alt="Current favicon"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <?php if($setting->hero_image): ?>
                        <img
                            src="<?php echo e(asset('storage/' . $setting->hero_image)); ?>"
                            alt="Home hero image"
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input
                        type="url"
                        name="facebook_url"
                        value="<?php echo e(old('facebook_url', $setting->facebook_url)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input
                        type="url"
                        name="twitter_url"
                        value="<?php echo e(old('twitter_url', $setting->twitter_url)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input
                        type="url"
                        name="instagram_url"
                        value="<?php echo e(old('instagram_url', $setting->instagram_url)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input
                        type="url"
                        name="linkedin_url"
                        value="<?php echo e(old('linkedin_url', $setting->linkedin_url)); ?>"
        ...
        <div class="bg-white rounded-lg shadow p-8 mb-6">
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    class="w-full border rounded-lg px-4 py-3"
                ><?php echo e(old('footer_text', $setting->footer_text)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex items-center gap-3">
                ...
                <input
                    ...
                    value="1"
                    class="w-5 h-5"
                    <?php echo e(old('maintenance_mode', $setting->maintenance_mode) ? 'checked' : ''); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\company-cms-laravel-ne\company-cms\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>