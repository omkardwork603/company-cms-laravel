...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-6">
                ...
                <input
                    type="number"
                    name="display_order"
                    value="<?php echo e(old('display_order', $service->display_order)); ?>"
                    min="0"
                    class="w-full border rounded-lg px-4 py-3"
                >
            ...
            <div class="mb-6">
                ...
                >
                    ...
                    <option value="1"
                        <?php echo e($service->status ? 'selected' : ''); ?>>
                        Active
                    </option>
